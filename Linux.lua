...
function Linux.Create(config)
    ...
    CloseButton.MouseButton1Click:Connect(function()
        Linux:Notify({Title = "UI Fechada", Content = "Pressione LeftAlt para reabrir.", Duration = 5})
        LinuxUI:Destroy()
        ToggleUI:Destroy()
    end)        
    ...
    task.spawn(function()
        ...
        if DefaultTab and Tabs[DefaultTab] then
            for _, tab in pairs(Tabs) do
                ...
                tab.ContainersWrapper.Visible = false
            ...
            defaultTab.ContainersWrapper.Visible = true
        ...
        elseif tabOrder > 0 then
            ...
            if firstTab then
                ...
                firstTab.ContainersWrapper.Visible = true
